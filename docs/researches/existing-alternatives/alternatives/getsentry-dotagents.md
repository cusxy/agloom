...
- Gemini CLI не поддерживается — один из целевых агентов Agloom.
...
агентов. Комплементарен Agloom: dotagents управляет внешними skills,
Agloom — трансляцией проектной конфигурации.
